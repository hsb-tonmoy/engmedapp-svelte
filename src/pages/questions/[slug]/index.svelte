        ...
        >
          ...
          >
            ...
            <div class="flex flex-col gap-y-2 font-bold font-mulish text-xs">
              <span
                class="flex items-center text-white pl-2 pr-3 rounded-md"
              ...
              >
              <span class="text-primary">Answered May 17 at 15:48</span>
            </div>
          </div>
        </div>
        <hr class="mt-8 mb-2" style="border-color: #A1A5B1" />
        <div
          class="explanations flex flex-col-reverse md:flex-row gap-x-8 py-4 md:py-8 px-3 md:px-12"
        >
